    ...
    <footer className="border-t border-pg-border">
      <div className="container-apple py-6 text-body-s text-pg-gray flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <nav className="flex gap-4">
          <Link href="/legal/privacy" className="hover:text-pg-navy transition-colors duration-200">
            Privacy
          </Link>
          <Link href="/legal/terms" className="hover:text-pg-navy transition-colors duration-200">
            Terms
          </Link>
          <a href="mailto:spencer@peoplesgrp.com" className="hover:text-pg-navy transition-colors duration-200">
            spencer@peoplesgrp.com
          </a>
          <Link href="/contact" className="hover:text-pg-navy transition-colors duration-200">
            Request Work
          </Link>
        </nav>
      </div>
