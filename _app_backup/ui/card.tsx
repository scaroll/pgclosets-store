...
function Card({
  ...
  return <div data-slot="card" className={cn(cardVariants({ variant, spacing }), className)} {...props} />
}
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("text-h5 text-foreground leading-none", className)} {...props} />
}
