...
export const QuoteConfirmationEmail = (props: QuoteConfirmationEmailData) => {
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your quote request {quoteNumber} has been received - We&apos;ll be in touch soon!
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Thank you for your interest in PG Closets! We&apos;ve received your quote request and
            ...
            <Section style={quoteBox}>
              ...
              <Text style={_quoteNumber}>{quoteNumber}</Text>
              <Text style={boxSubtext}>Received on {formattedDate}</Text>
            </Section>
            ...
            <Section style={nextStepsSection}>
              ...
              <Section style={stepItem}>
                ...
                <Text style={stepText}>
                  <strong>Quote Review</strong> - Our team will review your requirements and prepare
                  a detailed quote
                </Text>
              </Section>
              <Section style={stepItem}>
                ...
                <Text style={stepText}>
                  <strong>Personal Contact</strong> - A member of our sales team will reach out
              ...
              <Section style={stepItem}>
                ...
                <Text style={stepText}>
                  <strong>Custom Proposal</strong> - You&apos;ll receive a personalized quote with
              ...
              <Section style={stepItem}>
                ...
                <Text style={stepText}>
                  <strong>Free Consultation</strong> - Schedule a complimentary in-home consultation
            ...
            <Section style={contactSection}>
              ...
              <Text style={hoursText}>Business Hours: Monday - Friday, 9:00 AM - 5:00 PM EST</Text>
            </Section>
            ...
            <Hr style={divider} />
            <Text style={closing}>
              Thank you for considering PG Closets for your storage solution needs. We&apos;re
              excited to help transform your space!
            </Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>PG Closets - Ottawa&apos;s Premium Closet Solutions</Text>
            <Text style={footerText}>Ottawa, Ontario</Text>
            <Text style={footerText}>Phone: (613) 701-6393 | Email: info@pgclosets.com</Text>
