    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-overlay-dark':
          'linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.05) 20%, rgba(0,0,0,0.15) 40%, rgba(0,0,0,0.35) 60%, rgba(0,0,0,0.65) 80%, rgba(0,0,0,0.85) 100%)',
        'gradient-overlay-light':
          'linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.05) 20%, rgba(255,255,255,0.15) 40%, rgba(255,255,255,0.35) 60%, rgba(255,255,255,0.65) 80%, rgba(255,255,255,0.9) 100%)',
