...
export default function BookMeasurePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Calculate the date and time for the booking
      const bookingDate = new Date(formData.date)
      let startHour = 9 // Default morning
      if (formData.time === 'afternoon') startHour = 13
      else if (formData.time === 'evening') startHour = 17
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mb-8 text-xl text-muted-foreground">
                Thank you for booking a consultation with PG Closets. We&apos;ll contact you within
              ...
              <div className="mb-8 rounded-lg bg-muted/50 p-6">
                ...
                <ol className="space-y-3 text-left text-muted-foreground">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>Our team will call to confirm the appointment time</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary text-sm text-primary-foreground">
                      3
                    </span>
                    <span>A specialist will visit to take measurements and discuss options</span>
                  </li>
                </ol>
              </div>
              ...
              <CardContent className="pt-6">
                <form onSubmit={e => void handleSubmit(e)} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="bypass">Bypass Door Installation</SelectItem>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    >
                      I agree to be contacted by PG Closets regarding my consultation request. I
                      understand my information will be used only for scheduling and communication
                      purposes.
                    </Label>
                  </div>
