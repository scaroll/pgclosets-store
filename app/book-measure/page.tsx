...
export const metadata: Metadata = {
  ...
  description:
    "Schedule your free consultation with Ottawa's premier closet door specialists. Virtual consultations, showroom visits available. Official Renin dealer.",
  keywords:
    'closet consultation Ottawa, free measure, barn door installation, closet door estimate, Renin dealer',
}
          ...
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
                Our expert consultation ensures perfect results for your project
              </p>
            </div>
            ...
            <div className="relative grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="mb-3 text-2xl font-bold">Schedule & Connect</h3>
                  <p className="text-muted-foreground">
                    Book your free consultation online. Choose virtual, showroom, or email
                    consultation to discuss your needs and preferences.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    your beautiful new closet doors with expert craftsmanship.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="apple-transition rounded-2xl bg-card p-8 text-center shadow-lg hover:-translate-y-1 hover:shadow-xl">
                ...
                <h3 className="mb-3 text-2xl font-bold">Official Renin Dealer</h3>
                <p className="mb-4 text-muted-foreground">
