        ...
        <section className="bg-gradient-to-br from-gray-50 to-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="bg-white shadow-xl p-16 text-center">
              <h2 className="text-3xl font-extralight text-slate-900 mb-4 tracking-tight">
                Need Help Choosing?
              </h2>
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extralight text-slate-900 mb-4 tracking-tight">
            Shop by Category
          </h2>
          ...
          {productCategories.map((category, index) => (
            ...
            >
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-extralight text-slate-900 mb-2 tracking-wide group-hover:text-slate-700 transition-colors">
                  {category.name}
                </h3>
