          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="apple-transition hover:shadow-lg">
              ...
              <CardContent>
                ...
                <p className="mt-2 text-sm text-muted-foreground">24/7 response</p>
              </CardContent>
            </Card>
            ...
            <Card className="apple-transition hover:shadow-lg">
              ...
              <CardContent>
                ...
                <p className="mt-2 text-sm text-muted-foreground">Serving the greater area</p>
              </CardContent>
            </Card>
            ...
            <div>
              ...
              <form onSubmit={e => void handleSubmit(e)} className="space-y-6">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  >
                    I agree to be contacted by PG Closets regarding my inquiry. I understand my
                    information will be used in accordance with the privacy policy and will not be
                ...
                {submitStatus === 'success' && (
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                    <p className="font-medium text-green-800">
                      Thank you! We&apos;ve received your message and will be in touch within 24
                      hours.
                    </p>
                  </div>
                )}
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-8 rounded-lg bg-primary/5 p-4">
                  <p className="text-center text-sm">
                    <strong>Note:</strong> Emergency consultations available by appointment. Call us
                    to schedule outside regular hours.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <Card className="apple-transition hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Yes! We offer complimentary in-home consultations to assess your space and
              ...
              <Card className="apple-transition hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    All products come with a comprehensive lifetime warranty covering materials and
