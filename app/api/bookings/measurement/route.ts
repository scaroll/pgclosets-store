...
const sendEmailNotification = async (bookingData: MeasurementBookingData, confirmationNumber: string) => {
  ...
  const customerEmail = {
    ...
    html: `
      ...
      <p>If you need to reschedule or have any questions, please contact us at <a href="mailto:info@pgclosets.ca">info@pgclosets.ca</a> or call us at (613) 555-0123.</p>
