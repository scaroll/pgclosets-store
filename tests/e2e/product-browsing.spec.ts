...
test.describe('Product Browsing', () => {
  ...
  test('should view product details', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Add to Cart"), button:has-text("Get Quote")')).toBeVisible();
  });
...
test.describe('Product Quick Actions', () => {
  test('should add product to cart from listing', async ({ page }) => {
    ...
    const quickAddButton = page.locator('[data-testid="quick-add"], button:has-text("Add to Cart")').first();
  ...
  test('should quick view product', async ({ page }) => {
    ...
    const quickViewButton = page.locator('[data-testid="quick-view"], button:has-text("Quick View")').first();
