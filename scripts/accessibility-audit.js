        ...
        if (focused) {
          ...
          return {
            ...
            hasFocusStyle: style.outline !== 'none' || style.boxShadow !== 'none' ||
                           style.border.includes('2px') || style.border.includes('3px'),
...
function getFixRecommendation(issue) {
  const fixes = {
    'Missing alt text on images': 'Add descriptive alt text to all meaningful images. Use alt="" for decorative images with role="presentation"',
    'Color contrast problems': 'Ensure text has sufficient color contrast (4.5:1 for normal text, 3:1 for large text)',
